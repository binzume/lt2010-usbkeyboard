 ...
 */
#define USB_CFG_VENDOR_NAME     'b', 'i', 'n', 'z', 'u', 'm', 'e', '.'
 ...
 * details. 
 */
#define USB_CFG_DEVICE_NAME     'U', 'S', 'B', 'K', 'e', 'y', 's'
 ...
 * protocol.
 */
#define USB_CFG_HID_REPORT_DESCRIPTOR_LENGTH    (35+18)  /* total length of report descriptor */
 ...
 */
#define USB_INTR_CFG            PCMSK0 // MCUCR */
#define USB_INTR_CFG_SET        2 //((1 << ISC10) | (1 << ISC11))
/* #define USB_INTR_CFG_CLR        0 */
#define USB_INTR_ENABLE         PCICR //GIMSK
#define USB_INTR_ENABLE_BIT     PCINT0 //INT1
#define USB_INTR_PENDING        PCIFR // GIFR
